    ...
    <section id="careers" className="bg-white py-18 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-10">
          ...
          <h2 className="font-playfair font-black text-[#7c3a1e] text-4xl">Join BCSSK</h2>
          ...
          <p className="text-[#6b5744] text-sm mt-2 max-w-xl">
            We recruit skilled professionals committed to cooperative development and
            agricultural progress of Marathwada.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-12 items-start">
          {/* Info */}
          <div>
            <h3 className="font-playfair text-[#7c3a1e] text-2xl mb-2">Why Work With Us?</h3>
            ...
            <p className="text-[#6b5744] text-sm leading-relaxed mb-4">
              As a cooperative institution, BCSSK offers stable employment, government-aligned
              pay scales, and the satisfaction of directly impacting the lives of 18,000+
              farming families in Nanded.
            </p>
            <p className="text-[#6b5744] text-sm leading-relaxed">
              Recruitment follows GOM cooperative service rules — transparent, merit-based,
              and reservation-compliant.
            </p>
            ...
            <div className="bg-[#fdf6ec] border-[1.5px] border-[#ddd0b8] rounded-lg p-5 mt-6">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  >
                    <span className="text-[#c97d4e] font-bold flex-shrink-0">✓</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            {jobs.map((job) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-semibold text-[#1c1c1a] mb-0.5">{job.title}</h3>
                  <div className="font-marathi text-[#5a5a4f] text-xs">{job.titleMr}</div>
